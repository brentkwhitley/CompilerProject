...
public class CMinusParser implements parser {
    ...
    private Expression parseID(){
        ...
        IDExpression e = new IDExpression((String)(this.currToken.getTokenData()), null);
        advanceToken();
        return e;
    }
    ...
    private Param parseParamPrime(Expression id) throws Exception{
        Param p = null;
    ...
    private Statement parseExpressionStatement() throws Exception{
        ...
        if(peekToken() == IDENT_TOKEN ||
               peekToken() == NUMBER_TOKEN||
               peekToken() == LPAREN_TOKEN){
             e = parseExpression();
        }
        matchToken(SEMICOLON_TOKEN);
    ...
    private Statement parseCompoundStatement() throws Exception {
        ...
        while(currToken.getTokenType() == INT_TOKEN){
            ...
            if(peekToken() == LBRACKET_TOKEN){
                matchToken(LBRACKET_TOKEN);
                Expression n = parseNumExpression();
                matchToken(RBRACKET_TOKEN);
                Declaration d = new VarDeclaration(e, n);
                declarationList.add(d);
            }
            else{
                Declaration d = new VarDeclaration(e, null);
                declarationList.add(d); 
            }
        ...
        Statement CS = new CompoundStatement(declarationList, statementList);
       ...
       if(currToken.getTokenType() != null){
            ...
            switch (currToken.getTokenType()) {
                ...
                case LPAREN_TOKEN:
                    ...
                    Expression e = parseExpression();
                    matchToken(RPAREN_TOKEN);
                    Expression w = parseSimpleExpression(null);
